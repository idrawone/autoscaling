...
func (s *internalState) info(msg string, fields ...zap.Field) {
	if s.Config.Log.Info != nil {
		s.Config.Log.Info(msg, fields...)
	}
}

func (s *internalState) warn(msg string /* , fields ...zap.Field */) {
	if s.Config.Log.Warn != nil {
		s.Config.Log.Warn(msg /* , fields... */)
	}
}

func (s *internalState) warnf(msg string, args ...any) {
...
func (s *internalState) nextActions(now time.Time) ActionSet {
...
func (s *internalState) calculatePluginAction(
	now time.Time,
...
func (s *internalState) calculateNeonVMAction(
	now time.Time,
	desiredResources api.Resources,
...
func (s *internalState) calculateMonitorUpscaleAction(
	now time.Time,
	desiredResources api.Resources,
...
func (s *internalState) calculateMonitorDownscaleAction(
	now time.Time,
	desiredResources api.Resources,
...
func (s *internalState) scalingConfig() api.ScalingConfig {
...
func (s *internalState) desiredResourcesFromMetricsOrRequestedUpscaling(now time.Time) (api.Resources, func(ActionSet) *time.Duration) {
...
func (s *internalState) timeUntilRequestedUpscalingExpired(now time.Time) time.Duration {
...
func (s *internalState) requiredCUForRequestedUpscaling(computeUnit api.Resources, requestedUpscale requestedUpscale) uint32 {
	var required uint32
...
func (s *internalState) timeUntilDeniedDownscaleExpired(now time.Time) time.Duration {
	if s.Monitor.DeniedDownscale != nil {
...
func (s *internalState) requiredCUForDeniedDownscale(computeUnit, deniedResources api.Resources) uint32 {
...
func (s *internalState) minRequiredResourcesForDeniedDownscale(computeUnit api.Resources, denied deniedDownscale) api.Resources {
...
func (s *internalState) clampResources(
	current api.Resources,
...
func (s *internalState) monitorApprovedLowerBound() api.Resources {
...
func (s *internalState) pluginApprovedUpperBound() api.Resources {
